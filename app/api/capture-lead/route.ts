  ...
  try { 
    ...
    if (resend) { 
      const result = await resend.emails.send({ 
        // FIXED: Replaced "audits@yourdomain.com" to comply with Resend Sandbox Mode limitations
        from: "Credex Audits <onboarding@resend.dev>", 
        to: email, 
        subject: teamSizeNum && teamSizeNum > 50 ? "🚀 Your Infrastructure Audit Report - High Savings Priority" : "📊 Your Infrastructure Audit Report Confirmation", 
        html: ` 
          <div style="font-family:sans-serif;padding:20px;color:#333;"> 
            ...
            ${ 
              teamSizeNum && teamSizeNum > 50 ? "<p><strong>Note:</strong> Due to your enterprise configuration scale, a Credex engineering specialist will reach out within 24 hours to deliver targeted system recommendations.</p>" : "" 
            } 
